...
if (isset($_GET['search']) && $_GET['search'] != "") {
    ...
    $query = "SELECT * FROM trusts WHERE status_checked = 1 ORDER BY id DESC";
}
...
<head>
    ...
    <title>Checked Data | Waqf Data</title>
...
<form method="GET" style="margin: 20px 0;">
    <input type="text" name="search"
        placeholder="Search by Trust No / Name / Mobile / Area"
    ...
    <?php if(isset($_GET['search']) && $_GET['search'] != "") { ?>
        <a href="checked.php"><button type="button" class="btn" style="background:#6b7280;">Reset</button></a>
    <?php } ?>
</form>
    ...
    <table>
        ...
        ?>
            <tr>
                ...
                <td>
                    <!-- When unchecked, move back to Home list -->
                    <form method="POST" action="update_status.php">
                        <input type="hidden" name="id" value="<?php echo $row['id']; ?>">
                        <input type="hidden" name="status" value="0"> <!-- 0 = Unchecked -->
                        <input type="checkbox" class="chk" checked onchange="this.form.submit()">
                    </form>
                </td>
            </tr>
        <?php
            ...
            echo "<tr><td colspan='5' class='no-data'>No Checked Trust Records Found</td></tr>";
        }
        ?>
    </table>
</div>
